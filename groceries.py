...
def sort_special(product):
    return product["id"] + "-" + product["name"]



productsABC = sorted(products, key=sort_by_name)

for product in productsABC:

    print(" +", product["name"], "($" + str("{0:.2f}".format(product["price"])) +")")
...
nodup_list = list(set(departments))

nodup_list.sort()

department_count = len(nodup_list)


print("--------------")
print(f"THERE ARE {str(department_count)} DEPARTMENTS:")
print("--------------")
